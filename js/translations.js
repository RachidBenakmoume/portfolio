...
const translations = {
  fr: {
    ...
    about_text_1: "Étant en phase finale de mon parcours d'études en informatique à l'Université de Bretagne Occidentale, je conjugue formation théorique approfondie et expérience pratique dans le développement d'applications web. Ma passion pour la création de solutions digitales m'a conduit à maîtriser divers environnements technologiques.",
    about_text_2: "Mes compétences techniques couvrent l'ensemble du spectre du développement, de la conception d'interfaces utilisateur réactives jusqu'à l'implémentation d'architectures backend robustes. Je porte une attention particulière à la qualité du code et aux méthodologies de test, garantissant ainsi des applications fiables et performantes.",
    skills_title: "Mes compétences",
    
    // Experience Section
    experience_title: "Expérience Professionnelle",
    exp1_date: "04/2025 - Présent",
    ...
    edu2_intro: "Domaines d'expertise :",
  ...
  en: {
    ...
    about_text_1: "Currently in the final phase of my computer science studies at the University of Western Brittany, I combine in-depth theoretical training with practical experience in web application development. My passion for creating digital solutions has led me to master various technological environments.",
    about_text_2: "My technical skills cover the entire spectrum of development, from designing responsive user interfaces to implementing robust backend architectures. I pay particular attention to code quality and testing methodologies, thus ensuring reliable and high-performing applications.",
